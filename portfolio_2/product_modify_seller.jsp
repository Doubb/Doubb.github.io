...
<html>
    ...
    <form action="product_modify_auction.jsp?id=<%=request.getParameter("id")%>" method="post">
        <table border="1" id="list">
            ...
            <%
                try {
                    ...
                    ResultSet rs = st.executeQuery("SELECT * FROM new_schema.product WHERE seller='"+id+"' AND auction=1");
                    ...
                    <tr>
                        ...
                        <td><button type="submit" id="button" value="<%=i%>">Close auction</button></td>
                    </tr>
            <%
                        i++;
                    }
