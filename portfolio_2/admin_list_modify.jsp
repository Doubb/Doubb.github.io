...
<form action="modify_process.jsp" method="post">
    <table border="1" id="list">
        ...
        <%
            try{
                ...
                String[] id = {"id0", "id1", "id2", "id3", "id4", "id5", "id6", "id7", "id8", "id9"};
                String[] pw = {"pw0", "pw1", "pw2", "pw3", "pw4", "pw5", "pw6", "pw7"};
                String[] first = {"first0", "first1", "first2", "first3", "first4", "first5", "first6", "first7", "first8", "first9"};
                String[] last = {"last0", "last1", "last2", "last3", "last4", "last5", "last6", "last7", "last8", "last9"};
                String[] email = {"email0", "email1", "email2", "email3", "email4", "email5", "email6", "email7", "email8", "email9"};
                String[] bs = {"bs0", "bs1", "bs2", "bs3", "bs4", "bs5", "bs6", "bs7", "bs8", "bs9"};
        ...
        <tr>
            <td><input type="text" name="<%=id[i]%>" value="<%=rs.getString(1)%>"></td>
            <td><input type="text" name="<%=pw[i]%>" value="<%=rs.getString(2)%>"></td>
            <td><input type="text" name="<%=first[i]%>" value="<%=rs.getString(3)%>"></td>
            <td><input type="text" name="<%=last[i]%>" value="<%=rs.getString(4)%>"></td>
            <td><input type="text" name="<%=email[i]%>" value="<%=rs.getString(5)%>"></td>
            <td><input type="text" name="<%=bs[i]%>" value="<%=rs.getString(6)%>"></td>
        </tr>
    ...
    <div id="buttons">
    <input type="submit" value="mod" class="button">
    </div>
</form>
<footer>
    <div class="footer">
